...
Matrix4x4 MakeRotateAxisAngle(const Vector3& axis, float angle) {
	...
	rotateMatrix.m[0][1] = axis.y * axis.x * (1.0f - cos) + axis.z * sin;
	rotateMatrix.m[0][2] = axis.z * axis.x * (1.0f - cos) - axis.y * sin;

	rotateMatrix.m[1][0] = axis.x * axis.y * (1.0f - cos) - axis.z * sin;
	rotateMatrix.m[1][1] = axis.y * axis.y * (1.0f - cos) + cos;
	rotateMatrix.m[1][2] = axis.z * axis.y * (1.0f - cos) + axis.x * sin;
